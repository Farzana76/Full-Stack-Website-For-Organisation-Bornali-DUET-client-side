    ...
    return (
        <div className="row">
                <div className="w-75 m-auto p-3 mt-5 mb-3 add-service">
                    <h2 className="mb-3 heading fw-normal">Add Previous Secretary</h2>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className='row w-100'>
                            ...
                            <div className='col-lg-10'>
                                <input {...register("name", { required: true })} placeholder="Secretary's's Name" onChange={e => setName(e.target.value)}/>
                        ...
                        <div className='row w-100'>
                            ...
                            <div className='col-lg-10'>
                                <input defaultValue="Secretary" {...register("designation")} placeholder="Secretary" onChange={e => setDesignation(e.target.value)} readOnly/>
                            </div>
                        </div>
...
export default PreviousSecretary;