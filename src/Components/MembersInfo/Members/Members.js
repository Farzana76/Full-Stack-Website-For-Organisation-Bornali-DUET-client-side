...
const Members = () => {
    ...
    const handleSearch = event => {
        ...
        const matchedMembers = members.filter(member => member.blood.toLowerCase().includes(searchText.toLowerCase()) || member.name.toLowerCase().includes(searchText.toLowerCase()));
