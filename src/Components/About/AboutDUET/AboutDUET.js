    ...
    return (
        <div>
            ...
            <div className="box bg">
                <div className="bgw pb-5 pt-3">
                        <Carousel interval={2000} className="px-5 pt-5">
                            <Carousel.Item>
                                <img
                        ...
                        <h4 className="px-lg-5 mx-5 mt-4">
                            University Vision
                        </h4>
                        <h5 className="px-lg-5 mx-5">
                        ...
                        <ul className="px-lg-5 mx-lg-5 me-5 h5">
                            <li className="li">
                        ...
                        <h5 className="px-lg-5 mx-5 fw-bold">
